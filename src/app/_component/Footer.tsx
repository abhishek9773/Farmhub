          ...
          <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
            <div className="mx-auto max-w-sm lg:max-w-none">
              <p className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg dark:text-gray-400">
                Explore vibrant locations such as bustling farms in Bihar, the
                serene landscapes of Himachal Pradesh, the thriving agricultural
                hubs in Maharashtra, and many other regions across India. With
                our platform, you can easily connect with local farmers, access
                essential agricultural resources, and stay updated with the
                latest farming trends and services throughout the country
              </p>
